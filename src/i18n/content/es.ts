...
const es: TranslationContent = {
  meta: {
    title: "Dra. Estela Mas | Nefróloga — Salud Cardiorrenal",
    description:
      "Nefróloga especialista en salud cardiorrenal metabólica. Prevención del riesgo cardiovascular y consulta nefrológica online.",
  },
  nav: {
    homeLabel: "Inicio",
    aboutLabel: "Sobre mí",
